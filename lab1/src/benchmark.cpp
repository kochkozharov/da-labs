...
int main() {
    ...
    const int numBuckets = numberOfElements;
    ...
    std::sort(benchmarkData.begin(), benchmarkData.end(), cmp);
    ...
    auto duration2 =
        std::chrono::duration_cast<std::chrono::microseconds>(finish2 - start2);
    auto duration3 =
